...
gdown.download("https://drive.google.com/uc?id=1eyE-IIHpkswHhYnPXX3HByrZrSiXk00g", output='facenet_keras.h5', quiet=False)
print('Downloading deepface weights...')
gdown.download("https://drive.google.com/uc?id=1AkYZmHJ_LsyQYsML6k72A662-AdKwxsv", output='vgg_face_weights.h5', quiet=False)
...
gdown.download("https://drive.google.com/uc?export=download&id=1l5pUrV5ReapGd9uaBXrGsJ9eMQcOEqmD", output='meva_data.zip', quiet=False)
